...
- **SIGNED BUILD** means Windows validated a trusted publisher signature on that executable;
- **GITHUB BUILD** means the executable is not currently trusted as a signed publisher build.
